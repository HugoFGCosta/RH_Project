        ...
        <div class="row">
            ...
            <div class="groupYear">
                ...
                <select class="inputClass" name="month" id="month">
                    <option value="Todos"
                    @if($month === null || $month == "Todos") selected @endif
                    >Todos</option>

                    <option value="1"
                    @if($month == "Janeiro") selected @endif
                    >Janeiro</option>
                    <option value="2"
                            @if($month == "Fevereiro") selected @endif

                    >Fevereiro</option>
                    <option value="3"
                            @if($month == "Março") selected @endif

                    >Março</option>
                    <option value="4"
                            @if($month == "Abril") selected @endif
                    >Abril</option>
                    <option value="5"
                            @if($month == "Maio") selected @endif
                    >Maio</option>
                    <option value="6"
                            @if($month == "Junho") selected @endif
                    >Junho</option>
                    <option value="7"
                            @if($month == "Julho") selected @endif
                    >Julho</option>
                    <option value="8"
                            @if($month == "Agosto") selected @endif
                    >Agosto</option>
                    <option value="9"
                            @if($month == "Setembro") selected @endif
                    >Setembro</option>
                    <option value="10"
                            @if($month == "Outobro") selected @endif
                    >Outubro</option>
                    <option value="11"
                            @if($month == "Novembro") selected @endif
                    >Novembro</option>
                    <option value="12"
                            @if($month == "Dezembro") selected @endif
                    >Dezembro</option>
                </select>
